...
def locations():
    ...
    #print(all_locations)
    #print(all_holidays)
    return render_template('locations/index.jinja', input_locations = all_locations, input_all_holidays = all_holidays)
...
def single_location(id):
    ...
    return render_template('locations/single_location.jinja', input_location = one_location, has_visited = has_visited)
