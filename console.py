...
import repositories.holidays_repository as holiday_repo
...
holiday_repo.save(traveller_marco, country_iceland, '2002-02-02')
holiday_repo.save(traveller_neil, country_cuba, '2005-05-05') 
